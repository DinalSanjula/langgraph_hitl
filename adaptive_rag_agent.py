...
def answer_node(state:RAGState):
    ...
    prompt_template = ChatPromptTemplate.from_messages([
        ("system", """You are a helpful assistant that answers qustion based on the provided context.
...
def is_relevant_condition( state:RAGState):#this function return either True or false
...
graph.add_conditional_edges("validate_node", is_relevant_condition, {True:"answer_node",False:"web_search_node"})
